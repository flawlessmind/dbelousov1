package ru.mirea.pkmn.belousovdo.web.jdbc;
...
import static ru.mirea.pkmn.belousovdo.CardService.getCardFromResultSet;
import static ru.mirea.pkmn.belousovdo.StudentService.resultSetToStudent;
...
public class DatabaseServiceImpl implements DatabaseService  {
    ...
    public DatabaseServiceImpl(String propertiesFile) throws SQLException, IOException {
        ...
        PATH_TO_PROPERTIES = "src/main/resources/database.properties";
